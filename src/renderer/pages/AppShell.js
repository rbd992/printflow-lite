...
const Icons = {
  ...
  printer:   <svg width="15" height="15" viewBox="0 0 64 64" fill="none"><rect x="6" y="10" width="5" height="36" rx="2.5" fill="currentColor" opacity="0.35"/><rect x="53" y="10" width="5" height="36" rx="2.5" fill="currentColor" opacity="0.35"/><rect x="6" y="10" width="52" height="7" rx="3.5" fill="currentColor" opacity="0.6"/><rect x="22" y="10" width="20" height="11" rx="3" fill="currentColor"/><path d="M29 21 L32 29 L35 21 Z" fill="currentColor"/><rect x="20" y="42" width="24" height="4.5" rx="2" fill="currentColor" opacity="0.55"/><rect x="22" y="37" width="20" height="4.5" rx="2" fill="currentColor" opacity="0.45"/><rect x="24" y="32" width="16" height="4.5" rx="2" fill="currentColor" opacity="0.35"/><rect x="10" y="46" width="44" height="4" rx="2" fill="currentColor" opacity="0.4"/><rect x="7" y="50" width="50" height="7" rx="3.5" fill="currentColor" opacity="0.6"/><circle cx="52" cy="14" r="2.5" fill="currentColor" opacity="0.9"/></svg>,
